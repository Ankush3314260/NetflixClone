        ...
        <div className="trending-section mx-[10%]">
          ...
          >
            ...
            {trending.map((item: Movie) => (
              <SwiperSlide key={item.id}>
                <Link href={`/explore/movies/details/${item.title}capo-${item.id}`}>
          ...
          <div className="flex items-start w-[60%] m-auto  justify-evenly">
            <div
              ...
              className="w-max relative z-0 flex justify-center"
            >
              <svg
            ...
            <div
              ...
              className="w-max 0 pointer-events-none relative z-0 flex justify-center "
            >
              <svg
