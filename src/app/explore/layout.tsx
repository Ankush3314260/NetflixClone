    ...
    <div className="bg-[#050505] relative text-white  responsive-parent-text  ">
      ...
      <div className="relative">
        <nav className="py-8 text-[0.3em] relative blur-nav z-[999999]">
          <div className="flex justify-between ">
            <div className="w-2/5 flex justify-center">
              <Link href="/explore" className="w-full  flex justify-center">
                {" "}
                <Image
                  className="w-[30%] min-w-[50px] relative z-[9999999]  "
                  width="200"
                  height="100"
          ...
          <div
            className={`openMenu  absolute top-[0%] z-[999999] text-[#E70713] bottom-0 h-svh left-0 right-0   bg-[#05050573] backdrop-blur-sm  defualtMenu sm:hidden opacity-0 `}
          >
