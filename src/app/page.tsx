...
import Accordioncustom from "./mainComponents/Accordioncustom";
import TrendingCrousal from "./mainComponents/TrendingCrousal";
  ...
  return (
    <div className="relative sm:min-h-svh  bg-[#050505] responsive-parent-text  ">
            ...
            <div className="flex items-center relative -top-[10px] max-sm:-top-[3px] space-x-3 sm:w-2/5 max-sm:w-[70%] min-w-[100px]    justify-end">
              <button className="flex text-[0.20em] max-sm:text-[0.3em] items-center space-x-1 sm:w-[30%] max-sm:w-[30%] border-[1px] border-white justify-center min-w-[40px]  bg-[#000000a8] text-white py-[5px] px-1">
                ...
                <span className="block">
                  <svg
                    className="sm:w-[1.6vw] max-sm:w-[2vw] ml-auto mr-0"
        ...
        <div className="unlimited-section max-sm:py-[1em] sm:py-[1em]  sm:min-h-screen relative z-10 text-white ">
          <div className="leading-tight">
            ...
            <Link href="/explore" onClick={handleNavigate}>
              {" "}
              <button className="text-[0.5em] flex justify-center w-[25%] min-w-[100px] items-center relative z-10 text-white hover:bg-[#C11119] transition-all duration-200 bg-[#E50914] px-[1em] py-2 m-auto  rounded-md group ">
                <p className="w-[90%] "> Get Started</p>
                <p className="w-1/5">
                  <svg
                    className="group-hover:rotate-45 transtio duration-200 "
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="#fff"
                  >
      ...
      <div className="mx-[10%] text-white bg-[#050505] home-after-animation opacity-[0]">
        ...
        <div className="more-reason-container">
          <div className="reason-content">
            <div className="relative p-3">
              <p className="text-[0.45em]    max-sm:text-[0.65em]    ">
                {" "}
                <b> Enjoy on your TV</b>
              </p>
              <p className="text-[0.25em]    max-sm:text-[0.35em]   py-[5px] text-[#a8a8a8] ">
                Watch on smart TVs, PlayStation, Xbox, Chromecast, Apple TV,
                Blu-ray players and more.
              </p>
              <br />
              <p className="sm:hidden max-sm:visible">
                <br />
              </p>
          ...
          <div className="reason-content">
            <div className="relative p-3">
              ...
              <p className="text-[0.25em]    max-sm:text-[0.35em]   py-[10px] text-[#a8a8a8] ">
          ...
          <div className="reason-content">
            <div className="relative p-3">
              ...
              <p className="py-3 absolute bottom-0 right-0">
                <svg
                  className="ml-auto mr-0"
                  width="72"
                  height="72"
          ...
          <div className="reason-content">
            <div className="relative p-3">
              ...
              <p className="py-[5px] absolute right-0 bottom-0 ">
                <svg
                  className="ml-auto mr-0"
                  width="72"
                  height="72"
